...
import { switchTools } from "@/app/utilities/canvas/switchTools";
...
function ToolSelectionButton({ canvas, tool, setCurrentTool, currentTool, children }: { canvas: Canvas | null, tool: ToolItemName, setCurrentTool: (tool: ToolItemName) => void, currentTool: ToolItemName, children: React.ReactNode }) {
    return <button
        onClick={() => {
            setCurrentTool(tool);
